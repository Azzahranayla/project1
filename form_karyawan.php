...
<body>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow my-4">
            ...
            <form action="PS_karyawan.php" method="POST">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="first_name">Nama</label>
                            <input class="form-control" name="nama" type="text" placeholder="Enter your first name" required="">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Jenis Kelamin</label>
                            <input class="form-control" name="jenis_kelamin" type="text" placeholder="Also your last name" required="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" name="tempat_lahir" type="text" placeholder="Enter your first name" required="">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Tanggal Lahir</label>
                            <input class="form-control" name="tanggal_lahir" type="text" placeholder="Also your last name" required="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" name="no_hp" type="text" placeholder="Enter your first name" required="">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Golongan Darah</label>
                            <input class="form-control" name="gol_darah" type="text" placeholder="Also your last name" required="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" name="alamat" type="text" placeholder="Enter your first name" required="">
                        </div>
                    </div>
                    <div class="col-sm-4 mb-3">
                        <label for="jabatan">divisi</label>
                        <select class="form-select w-100 mb-0" id="divisi" name="divisi" aria-label="select example">
                            <?php
                            include "config.php";
                            ...
                            foreach ($query as $data) { ?>
                                <option><?php echo $data['nama_divisi'] ?></option>
                            <?php  } ?>
                        </select>
                    ...
                    <div class="col-sm-4 mb-3">
                        ...
                        <select class="form-select w-100 mb-0" id="jabatan" name="jabatan" aria-label="jabatan select example">
                            <?php
                            include "config.php";
