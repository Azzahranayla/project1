    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <h2 class="h4">KARYAWAN</h2>
                <p class="mb-0">Your web analytics dashboard template.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="form_karyawan.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">tempat lahir</th>
                        <th class="border-gray-200">tanggal lahir</th>
                        <th class="border-gray-200">no.hp</th>
                        <th class="border-gray-200">gol.darah</th>
                        <th class="border-gray-200">alamat</th>
                        <th class="border-gray-200">divisi</th>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="PH_karyawan.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php }
                    ?>
