    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <h2 class="h4">DIVISI</h2>
                <p class="mb-0">Your web analytics dashboard template.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="form_divisi.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">Nama Divisi</th>
                        <th class="border-gray-200">Singkatan Divisi</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php echo $data['singkatan_divisi'] ?>
                            </td>
                            <td>
                                <a href="edit_divisi.php?id=<?php echo $data['id'] ?>" class="btn btn-warning">Edit</a>
                                <a href="PH_divisi.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Hapus</a>
                            </td>
                        </tr>
                    <?php   }
                    ?>
