...
include "config.php";
$id = $_GET['id'];
$sql = "SELECT * FROM divisi WHERE id= '$id' ";
...
<body>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow my-4">
            <h2 class="h5 mb-4">General information DIVISI</h2>
            <form action="PE_divisi.php" method="POST">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="first_name">Nama Divisi</label>
                            <input class="form-control" name="nama_divisi" type="text" placeholder="tulis nama divisi" value="<?= $result['nama_divisi'] ?>" required="">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Singkatan Divisi</label>
                            <input class="form-control" name="singkatan_divisi" type="text" placeholder="tulis singkatan divisi" value="<?= $result['singkatan_divisi'] ?>" required="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" name="id" type="hidden" placeholder="tulis singkatan divisi" value="<?= $result['id'] ?>" required="">
                    </div>
                </div>
        </div>
        <div class="mt-3">
