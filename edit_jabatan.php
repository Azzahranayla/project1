...
<body>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow my-4">
            <h2 class="h5 mb-4">General information JABATAN</h2>
            <form action="PE_divisi.php" method="POST">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="first_name">Nama Jabatan</label>
                            <input class="form-control" name="nama_jabatan" type="text" placeholder="tulis nama jabatan" value="<?= $result['nama_jabatan'] ?>" required>
                        </div>
                        <div>
                            <label for="first_name">Singkatan Jabatan</label>
                            <input class="form-control" name="singkatan_jabatan" type="text" placeholder="tulis singkatan jabatan" value="<?= $result['singkatan_jabatan'] ?>" required>
                        </div>
                        <div>
                            <label for="first_name"></label>
                            <input class="form-control" name="id" type="hidden" placeholder="tulis id" value="<?= $result['id'] ?>" required>
                        </div>
                    </div>
