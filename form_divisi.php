...
<body>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow my-4">
            ...
            <form action="PS_divisi.php" method="POST">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="first_name">Nama Divisi</label>
                            <input class="form-control" name="nama_divisi" type="text" placeholder="tulis nama divisi" required="">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Singkatan Divisi</label>
                            <input class="form-control" name="singkatan_divisi" type="text" placeholder="tulis singkatan divisi" required="">
                        </div>
                    </div>
                </div>
                <div class="mt-3">
